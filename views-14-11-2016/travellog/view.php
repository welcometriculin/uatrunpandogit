        ...
        'columns' => [
			...
			'value' => function ($data) {
				if ($data['activity'] == 'Farm and Home Visit') {
					return '<div class="img-wd">'.Html::img(Url::home().'/../img/fhv.png').'</div>';
				} elseif ($data['activity'] == 'Farmer Group Meeting') {
					return '<div class="img-wd">'.Html::img(Url::home().'/../img/fgm.png').'</div>';
				} elseif ($data['activity'] == 'Mass Campaign') {
					return '<div class="img-wd">'.Html::img(Url::home().'/../img/mass-campaign.png').'</div>';
				} elseif ($data['activity'] == 'Demonstration') {
					return '<div class="img-wd">'.Html::img(Url::home().'/../img/demo.png').'</div>';
				} elseif ($data['activity'] == 'start'){
					return '<div class="img-wd">'.Html::img(Url::home().'/../img/start-mdpi.png').'</div>';
				} elseif ($data['activity'] == 'stop'){
					return '<div class="img-wd">'.Html::img(Url::home().'/../img/stop-mdpi.png').'</div>';
				}  elseif ($data['activity'] == 'Channel Card'){
					return '<div class="img-wd">'.Html::img(Url::home().'/../img/channel-partner1.png').'</div>';
				} 
			}
			],
    		[
