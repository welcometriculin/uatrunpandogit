...
<div class="channel-partners-form">

     <?php $form = ActiveForm::begin(); ?>
      <div class="form-group clearfix">
	<?= $form->field($model, 'managefield',['template' => "{label}\n<div class='col-xs-12 col-sm-5 col-md-4 pr0 pl0 '>{input}</div>\n{hint}\n{error}"])->dropDownList($mmlist,['prompt' => 'Select Manager Name'])->label('Manager Name',['class'=>'col-xs-12 col-sm-5 col-md-2 col-lg-2 control-label'])  ?></div>
