     ...
     <div class="panel-group form-accordion" id="accordion">
        ...
        <div class="white-box">
          <h3>First field</h3>
                                       ...
                                       <?= $form->field($model, 'step_1_field1_stepno')->hiddenInput(['value'=> 1])->label(false); ?>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseTwo" class="accordion panel-collapse collapse">
                                        <div class="panel-body">
                                          <div class="white-box">
                                           <h3>1. Field 1</h3><?php $model->step_2_field1_require = '1'; ?>
                                         <?= $form->field($model, 'step_2_field1_stepno')->hiddenInput(['value'=> 2])->label(false); ?>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseThree" class="accordion panel-collapse collapse">
                                        ...
                                        <div class="white-box mb15">
                                            <h3>1. Field 1</h3><?php $model->step_3_field1_require = '1'; ?>
                                          <?= $form->field($model, 'step_3_field1_stepno')->hiddenInput(['value'=> 3])->label(false); ?>   
                                         ...
                                         <div class="white-box mb15">
                                       <h3> 2. Field 2</h3><?php $model->step_3_field2_require = '1'; ?>
                                        <?= $form->field($model, 'step_3_field2_stepno')->hiddenInput(['value'=> 3])->label(false); ?>
                                        ...
                                        <div id = "fgm">
                                         <div class="white-box mb15">
                                       <h3> 3. Field 3</h3><?php $model->step_3_field3_require = '1'; ?>
                                        <?= $form->field($model, 'step_3_field3_stepno')->hiddenInput(['value'=> 3])->label(false); ?>
                                        ...
                                        <?= $form->field($model, 'step_3_field3_no_of_images',['template' => "<div class='row'><div class='col-xs-12 col-sm-6 col-md-5  col-lg-4'>{label}</div>\n<div class='col-xs-12 col-sm-6 col-md-7 col-lg-4'>{input}</div>\n{error}</div>\n{hint}"])->hiddenInput(['value' => 0])->label(false) ?>
                                         ...
                                         <div id = "mc">
                                          <div class="white-box mb15">
                                        <h3>4. Field 4</h3><?php $model->step_3_field4_require = '1'; ?>
                                        <?= $form->field($model, 'step_3_field4_stepno')->hiddenInput(['value'=> 3])->label(false); ?>
                                        ...
                                        <?= $form->field($model, 'step_3_field5_stepno')->hiddenInput(['value'=> 3])->label(false); ?>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseFour" class="accordion panel-collapse collapse">
                                        <div class="panel-body">
											<div id ="fhv">
											 <div class="white-box">
											<h3>1. Field 1</h3><?php $model->step_4_field1_require = '1'; ?>
											<?= $form->field($model, 'step_4_field1_stepno')->hiddenInput(['value'=> 4])->label(false); ?>
                                 ...
                                 <div class="panel panel-default">
                                    ...
                                    <div id="collapseFive" class="accordion panel-collapse collapse">
                                        <div class="panel-body">
                                         <div class="white-box">
                                       <?= $form->field($model, 'step_5_field1_stepno')->hiddenInput(['value'=> 5])->label(false); ?>
 									<h3>1. Field 1</h3><?php $model->step_5_field1_require = '1'; ?>
