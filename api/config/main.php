...
$config = [
		...
		'components' => [
				...
				'user' => [
						'identityClass' => 'app\api\modules\v4\models\User',
				...
				'response' => [
						...
						'on beforeSend' => function ($event) {
							if(Yii::$app->response->statusCode == 401) {
								...
								$response->data = [
										'message' => 'Something went wrong. Please login again', 'status' => true, 'status_code' => '401'
								];
						...
						/*swift mailer*/
								...
								'urlManager' => [
										...
										'rules' => [
												...
												['class' => 'yii\rest\UrlRule', 'controller' => 'v4/login','extraPatterns' => ['POST'=>'login','POST forgot'=>'forgot','POST signup'=>'signup'],'pluralize'=>false],
												['class' => 'yii\rest\UrlRule', 'controller' => 'v4/user','extraPatterns' => ['GET'=>'user','GET image' => 'usr']],
												['class' => 'yii\rest\UrlRule', 'controller' => 'v4/plancard','extraPatterns' => ['GET'=>'cardview','POST'=>'getcard', 'POST create' => 'createcard', 'POST submit' => 'submit','GET check' =>'getdata','GET date' =>'date','POST complete'=>'complete','GET location'=>'location','POST cards'=>'allcards','POST products'=>'products','POST channel'=>'chcard', 'POST travellog' => 'travellog', 'POST travellogstartstop' => 'travellogstartstop' ]],
												['class' => 'yii\rest\UrlRule', 'controller' => 'v4/profile','extraPatterns' => ['GET detail'=>'details','POST edit'=>'edit', 'POST changepassword' => 'changepassword'],'pluralize'=>false],
												['class' => 'yii\rest\UrlRule', 'controller' => 'v4/syncdb','extraPatterns' => ['POST origin'=>'origin','POST originoffline'=>'originoffline','GET menu'=>'menu','POST offline'=>'offline','POST imagesync' =>'imagesync','GET dynamicform' =>'dynamicform' ],'pluralize'=>false],
												['class' => 'yii\rest\UrlRule', 'controller' => 'v4/createplan','extraPatterns' => ['POST crop'=>'addcrop'],'pluralize'=>false],
												['class' => 'yii\rest\UrlRule', 'controller' => 'v4/performance','extraPatterns' => ['GET travellog'=>'travellog','POST performancelog' => 'performancelog'],'pluralize'=>false],
										],
								],
								'db' => $db,
								],
								'modules' => [
										...
										'v4' => [
												'class' => 'app\api\modules\v4\Module',
										],
								],
								'params' => $params,
								];
