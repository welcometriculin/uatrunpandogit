...
class ChannelPartners extends Kg
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'channel_partner_name' => (count($label_names_display = LabelNames::labelNamesDisplay()) > 0 ? ucfirst($label_names_display['partner_label']) :'Partner Name'),
            'comp_id' => 'Comp ID',
