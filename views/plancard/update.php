...
<?php 
    ...
    $listData = \app\models\PlanCards::Userslistdetails($model->assign_to);
		...
		<div class="form-group col-md-3">
			<?= $form->field($model, 'planned_date')->widget(yii\jui\DatePicker::className(),
				...
				'placeholder' => $model->getAttributeLabel('planned_date'),
                    	 		'disabled'=>($model->plan_approval_status == 'Approved' ?true:false), 'autocomplete' => 'off', 'onpaste' => 'return false;', 'onkeypress' => 'return false;'
                         ],]) ?>
		</div>
		<div class="form-group col-md-3">
