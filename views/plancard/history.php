...
/*clicked tabs stay active start*/
	sessionStorage.historytabClicked;
	if ("$controller" != 'plancard'){
		sessionStorage.removeItem('historytabClicked');
	}
	$('.tabs li').click(function(){
		sessionStorage.historytabClicked = $(this).prevAll().length;
	});
	if (sessionStorage['historytabClicked']) {
		if (sessionStorage.historytabClicked != '' && sessionStorage.historytabClicked != 'undefined') {
			$('.tabs li:eq('+sessionStorage.historytabClicked+')' ).find('a').click();
		}
	}
