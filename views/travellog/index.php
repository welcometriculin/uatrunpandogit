...
<div class="travel-log">
	...
	<?= GridView::widget([
        ...
        'columns' => [
    		...
    		'format'=> 'raw',
    		'value'=> function ($data) {
    		return Html::a(Html::tag('span', Html::encode(ucwords($data['first_name'])), ['class' =>'plans']), Url::to(['travellog/view/'.$data['guid'].'/'.rtrim(strtr(base64_encode(substr($data["updated_date"],0,10)), '+/', '-_'), '=')]), ['title' => $data['first_name']]);
