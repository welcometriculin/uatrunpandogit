...
<div id="map-container" class="" style="position: relative; background-color: rgb(229, 227, 223); overflow: hidden;">
	...
	<div class="form-horizontal travel-block clearfix">
			...
			<div class="col-sm-6 col-md-3 ">
				<div class="form-group">
					<div class="">
					<label class="control-label">Field Force:</label> <label
						class="control-input"><?= $ff_name ?>
					</label>
					</div>
				</div>
			</div>
...
<?php Pjax::begin([ 'timeout' => false, 'enablePushState' => false, 'clientOptions' => ['method' => 'POST']])  ?>
        ...
        'columns' => [
    		...
    		[
    				'attribute' => 'time',
    				'label'=> 'Spent Time (H:M:S)',
    				'enableSorting' => false,
    				'format'=> 'raw',
    				'value'=> function ($data) {
    				return Travellog::travellogtime(abs($data['time']));
    		}
    		],
    		[
    				...
    				'format'=> 'raw',
    				'value'=> function ($data) {
    				return substr($data['distance_travelled'], 0 ,strpos($data['distance_travelled'], '.')+4);
    		}
    		],
    		[
    				'attribute' => 'mode',
