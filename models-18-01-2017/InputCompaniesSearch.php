...
class InputCompaniesSearch extends InputCompanies
{
    ...
    public function rules()
    {
        return [
            ...
            [['guid', 'organization_name', 'person_name', 'contact_email', 'phone_number', 'number_of_licences', 'status', 'created_date', 'updated_date'], 'safe'],
            [['paid_amount'], 'number'],
        ];
    }
...
//             ->andFilterWhere(['like', 'number_of_licences', $this->number_of_licences])
