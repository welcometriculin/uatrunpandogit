...
<div class="villages-update">
   ...
   <div class="form-group clearfix"> <?= $form->field($model, 'village_name',['template' => "{label}\n<div class='col-xs-12 col-sm-5 col-md-4 pr0 pl0 '>{input}</div>\n{hint}\n{error}"])->textInput(['maxlength' => true])->label((count($label_names_display) > 0 ? ucfirst($label_names_display['village_label']) :'Village'),['class'=>'col-xs-12 col-sm-5 col-md-2 col-lg-2 control-label'])   ?>    </div>
